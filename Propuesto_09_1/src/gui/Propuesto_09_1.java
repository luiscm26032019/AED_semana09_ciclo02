...
public class Propuesto_09_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnAdicionar(ActionEvent arg0) {
		...
		Factura nueva = new Factura (ruc, empresa , unidades , precio);
		af.adicionar(nueva);
		listar();
		limpieza();
	}
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		 ...
		 */
		txtS.setText("");
		imprimir("Suma importes facturados :  " + af.sumaImpFac());
		imprimir("Importe promedio facturado :  " + af.impPromFac());
		imprimir("Menor importe facturado :  " + af.menorImpFac());
		imprimir("Mayor importe facturado :  " + af.mayorImpFac());
		imprimir("1° empresa impFacturado < promFacturado :  " + af.nomPrimEmp());
  	}
